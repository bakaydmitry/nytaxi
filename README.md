...
1) [Карта](https://github.com/bakaydmitry/nytaxi/blob/master/map.zip) с визуализацией реального и прогнозируемого спроса на такси в выбираемый пользователем момент времени
2) [Временной ряд](https://github.com/bakaydmitry/nytaxi/blob/master/curves.zip) фактического и прогнозируемого спроса на такси в выбираемой области
